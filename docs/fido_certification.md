...
| Discoverable Credential IVs      | 16-byte random values | N/A      | Ensure every stored value has different encrypted blocks              | N      | Per credential    | Flash              | Never         | Never           | When credential deleted                     | 
...
| Discoverable Public Key          | 64-byte stored        | N/A      | Stored public key for credential as uncompressed X, Y points on P-256 | N      | Per credential    | Flash              | Never         | CTAP            | When credential deleted                     | 
