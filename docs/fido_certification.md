...
| Credential Private Key           | ECDSA key on P-256    | 128      | Generate credential signatures                                        | Y      | Per credential    | RAM/External | Never         | CTAP in Credential | From RAM immediately after use          | 
